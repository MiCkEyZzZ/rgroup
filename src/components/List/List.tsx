                                        ...
                                        <div className="list-table-item__user-title">
                                            ...
                                            <span className='list-table-item__user-status'>
                                                    {character.status === 'Alive'
                                                        ? <span className='list-table-item__user-status--icon list-table-item__user-status--alive'>
                                                            <span className='hidden'>Alive</span>
                                                          </span>
                                                        : character.status === 'Dead'
                                                            ? <span className='list-table-item__user-status--icon list-table-item__user-status--dead'>
                                                            <span className='hidden'>Dead</span>
                                                          </span>
                                                            : <span className='list-table-item__user-status--icon list-table-item__user-status--unknown'>
                                                            <span className='hidden'>Unknown</span>
                                                          </span>
                                                    }
